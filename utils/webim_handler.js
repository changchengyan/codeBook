    ...
    webim.applyJoinBigGroup(
        ...
        function (resp) {
            ...
            if (resp.JoinedStatus && resp.JoinedStatus == 'JoinedSuccess') {
                webim.Log.info('进群成功');
                selToID = groupId;
                var content = "{\"userAction\":\"6\",\"userName\":\"" + loginInfo.identifierNick + "\",\"userId\":\"" + loginInfo.identifier + "\",\"headPic\":\"\",\"msg\":\"进入了房间\",\"groupId\":\"" + groupId + "\"}";
                onSendMsg(content, null);
            } else {
                console.error('进群失败');
            }
        },
...
function convertGroupTipMsgToHtml(content) {
    ...
    //系统提示
  //  text += "{\"userAction\":\"1\",\"userName\":\"系统\",\"headPic\":\"\",\"msg\":\"";
    switch (opType) {
